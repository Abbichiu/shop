...
session_start();
    ...
    if(!preg_match($regex_email,$email)){
        ...
        ?>
        <meta http-equiv="refresh" content="2;url=/Shop/Shop/signup.php" />
        <?php
    }
    ...
    $duplicate_user_result=mysqli_query($conn,$duplicate_user_query) or die(mysqli_error($con));
    ...
    if($rows_fetched>0){
        ...
        <meta http-equiv="refresh" content="1;url=/Shop/Shop/signup.php" />
        <?php
    }else{
        ...
        //header('location:/Shop/Shop/products.php');  //for redirecting
        ?>
